...
singularity exec muscope-18SV4.img /opt/local/cyverse-app/miniconda/bin/python write_launcher_job_file.py -i ${INPUT_DIR} -j ${LAUNCHER_JOB_FILE} -w ${OUTPUT_DIR}/work-${SLURM_JOB_ID}-{prefix}
sleep 10
